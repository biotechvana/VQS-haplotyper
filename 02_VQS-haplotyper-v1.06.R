...
option_list <- list(
	...
	make_option("--min_rd", action = "store", default = 1, type = "numeric", help = "Filter haplotypes by a minimum number of reads before intersection step [default %default]"),
	make_option("--a_cut", action = "store", default = 0.0, type = "numeric", help = "Filter haplotypes by abundance before intersection step (in percentage) [default %default]"),
	make_option("--ni_thr", action = "store", default = 2.0, type = "numeric", help = "Save haplotypes with a specific abundance or below (in percentage) [default %default]"),
